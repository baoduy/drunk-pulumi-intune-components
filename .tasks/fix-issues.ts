...
const searchText = 'NodeStream as GenericNodeWebStream'; // Text to be replaced
const replacementText = 'NodeWebStream as GenericNodeWebStream'; // Text to replace with
